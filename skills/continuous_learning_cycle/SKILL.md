...
parameters:
  ...
  - name: learning_objective
    type: string
    default: establish_baseline_performance
returns:
  - status
  - final_state
  - next_action
...
- YOLO inference through the active Maix Python `run_yolo` skill
...
2. **Process**: Run YOLO inference with Maix Python `run_yolo`
